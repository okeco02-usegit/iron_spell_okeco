...
public class ThunderstormEffect extends MagicMobEffect {
   ...
   public void m_6742_(LivingEntity entity, int pAmplifier) {
      ...
      entity.f_19853_
         .m_6443_(
            LivingEntity.class,
            entity.m_20191_().m_82377_(20.0, 12.0, 20.0),
            livingEntity -> livingEntity != entity
               && this.horizontalDistanceSqr(livingEntity, entity) < radiusSqr
               && livingEntity.m_6087_()
               && !livingEntity.m_5833_()
               && !Utils.shouldHealEntity(entity, livingEntity)
               && Utils.hasLineOfSight(entity.f_19853_, entity, livingEntity, false)
         )
   ...
   public static float getDamageFromAmplifier(int effectAmplifier, @Nullable LivingEntity caster) {
      ...
      return (effectAmplifier - 7) * power + 7.0F;
   }
}
