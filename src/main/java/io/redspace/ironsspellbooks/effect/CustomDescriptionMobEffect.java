...
public abstract class CustomDescriptionMobEffect extends MagicMobEffect {
   ...
   public static void handleCustomPotionTooltip(
      ItemStack itemStack,
      List<Component> tooltipLines,
      boolean isAdvanced,
      MobEffectInstance mobEffectInstance,
      CustomDescriptionMobEffect customDescriptionMobEffect
   ) {
      Component description = customDescriptionMobEffect.getDescriptionLine(mobEffectInstance);
      MutableComponent header = Component.m_237115_("potion.whenDrank").m_130940_(ChatFormatting.DARK_PURPLE);
