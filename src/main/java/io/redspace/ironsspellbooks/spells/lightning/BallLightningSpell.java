...
public class BallLightningSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "ball_lightning");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      balllightning.m_146884_(entity.m_20182_().m_82520_(0.0, entity.m_20192_() - balllightning.m_20191_().m_82376_() * 0.5, 0.0));
