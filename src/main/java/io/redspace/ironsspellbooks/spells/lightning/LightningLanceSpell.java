...
public class LightningLanceSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "lightning_lance");
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      lance.m_146884_(entity.m_20182_().m_82520_(0.0, entity.m_20192_(), 0.0).m_82549_(entity.m_20156_()));
