...
public class ElectrocuteSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "electrocute");
   ...
   public Optional<SoundEvent> getCastFinishSound() {
      return Optional.of((SoundEvent)SoundRegistry.ELECTROCUTE_LOOP.get());
   }
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      if (playerMagicData.isCasting()
         ...
         electrocuteProjectile.m_146884_(entity.m_20182_().m_82520_(0.0, entity.m_20192_() * 0.7, 0.0));
