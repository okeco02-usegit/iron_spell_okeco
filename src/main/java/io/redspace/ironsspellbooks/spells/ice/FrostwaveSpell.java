...
public class FrostwaveSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "frostwave");
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      MagicManager.spawnParticles(
         level,
         new BlastwaveParticleOptions(((SchoolType)SchoolRegistry.ICE.get()).getTargetingColor(), radius),
         entity.m_20185_(),
      ...
      PacketDistributor.sendToPlayersTrackingEntityAndSelf(
         ...
         new ShockwaveParticlesPacket(
            new Vec3(entity.m_20185_(), entity.m_20186_() + 0.165F, entity.m_20189_()), radius, (ParticleType)ParticleRegistry.SNOWFLAKE_PARTICLE.get()
         )
      );
      level.m_6249_(
            entity,
         ...
         .forEach(
            target -> {
               if (target instanceof LivingEntity livingEntity && livingEntity.m_20280_(entity) < radius * radius) {
                  livingEntity.m_7292_(new MobEffectInstance((MobEffect)MobEffectRegistry.CHILLED.get(), this.getDuration(spellLevel, entity)));
                  MagicManager.spawnParticles(
                     level,
