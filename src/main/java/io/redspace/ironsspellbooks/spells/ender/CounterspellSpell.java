...
public class CounterspellSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "counterspell");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
            ...
            if (hitEntity instanceof AntiMagicSusceptible antiMagicSusceptible) {
               if (antiMagicSusceptible instanceof IMagicSummon summon) {
                  if (summon.getSummoner() == entity) {
                     if (summon instanceof Mob mob && mob.m_5448_() == null) {
      ...
      for (float i = 1.0F; i < distance; i += 0.5F) {
         Vec3 pos = entity.m_146892_().m_82549_(forward.m_82490_(i));
         MagicManager.spawnParticles(world, ParticleTypes.f_123809_, pos.f_82479_, pos.f_82480_, pos.f_82481_, 1, 0.0, 0.0, 0.0, 0.0, false);
      }
