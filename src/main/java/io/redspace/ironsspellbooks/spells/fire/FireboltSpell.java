...
public class FireboltSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "firebolt");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      firebolt.m_146884_(entity.m_20182_().m_82520_(0.0, entity.m_20192_() - firebolt.m_20191_().m_82376_() * 0.5, 0.0));
