...
public class BurningDashSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "burning_dash");
   ...
   public void onClientCast(Level level, int spellLevel, LivingEntity entity, ICastData castData) {
      if (castData instanceof ImpulseCastData bdcd) {
         ...
         entity.m_20256_(entity.m_20184_().m_82520_(bdcd.x, bdcd.y, bdcd.z));
      }
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      if (playerMagicData.getAdditionalCastData() instanceof BurningDashSpell.BurningDashDirectionOverrideCastData) {
         if (Utils.random.m_188499_()) {
            forward = forward.m_82524_(90.0F);
         } else {
            forward = forward.m_82524_(-90.0F);
         }
      }

      Vec3 vec = forward.m_82542_(3.0, 1.0, 3.0).m_82541_().m_82520_(0.0, 0.25, 0.0).m_82490_(multiplier);
      if (entity.m_20096_()) {
         entity.m_146884_(entity.m_20182_().m_82520_(0.0, 1.5, 0.0));
         vec.m_82520_(0.0, 0.25, 0.0);
      }

      playerMagicData.setAdditionalCastData(new ImpulseCastData((float)vec.f_82479_, (float)vec.f_82480_, (float)vec.f_82481_, true));
      entity.m_20256_(
         new Vec3(
            Mth.m_14139_(0.75, entity.m_20184_().f_82479_, vec.f_82479_),
            Mth.m_14139_(0.75, entity.m_20184_().f_82480_, vec.f_82480_),
            Mth.m_14139_(0.75, entity.m_20184_().f_82481_, vec.f_82481_)
         )
      );
      entity.m_7292_(new MobEffectInstance((MobEffect)MobEffectRegistry.BURNING_DASH.get(), 15, this.getDamage(spellLevel, entity), false, false, false));
      entity.f_19802_ = 20;
