...
public class ShieldSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "shield");
   ...
   public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
      return List.of(Component.m_237110_("ui.irons_spellbooks.hp", new Object[]{Utils.stringTruncation(this.getShieldHP(spellLevel, caster), 1)}));
   }
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      Vec3 spawn = Utils.raycastForEntity(level, entity, 3.0F, true).m_82450_();
