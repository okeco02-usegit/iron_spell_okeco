...
public class ArrowVolleySpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "arrow_volley");
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      if (targetLocation == null) {
         targetLocation = Utils.raycastForEntity(level, entity, 100.0F, true).m_82450_();
      }
      ...
      Vec3 raycastTarget = Utils.moveToRelativeGroundLevel(level, targetLocation.m_82520_(0.0, 2.0, 0.0), 4).m_82549_(backward).m_82520_(0.0, 6.0, 0.0);
      Vec3 spawnLocation = Utils.raycastForBlock(level, targetLocation, raycastTarget, Fluid.NONE).m_82450_();
      spawnLocation = spawnLocation.m_82546_(targetLocation).m_82490_(0.9F).m_82549_(targetLocation);
      float dx = Mth.m_14116_(
         (float)(
            (spawnLocation.f_82479_ - targetLocation.f_82479_) * (spawnLocation.f_82479_ - targetLocation.f_82479_)
               + (spawnLocation.f_82481_ - targetLocation.f_82481_) * (spawnLocation.f_82481_ - targetLocation.f_82481_)
         )
      );
      float arrowAngleX = dx == 0.0F ? 70.0F : (float)(Mth.m_14136_(dx, spawnLocation.f_82480_ - targetLocation.f_82480_) * 180.0F / (float)Math.PI);
      float arrowAngleY = entity.m_20185_() == targetLocation.f_82479_ && entity.m_20189_() == targetLocation.f_82481_
         ? (entity.m_146908_() - 90.0F) * (float) (Math.PI / 180.0)
         : Utils.getAngle(entity.m_20185_(), entity.m_20189_(), targetLocation.f_82479_, targetLocation.f_82481_);
      ArrowVolleyEntity arrowVolleyEntity = new ArrowVolleyEntity((EntityType<? extends Projectile>)EntityRegistry.ARROW_VOLLEY_ENTITY.get(), level);
