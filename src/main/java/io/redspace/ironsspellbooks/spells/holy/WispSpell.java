...
public class WispSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "wisp");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      if (playerMagicData.getAdditionalCastData() instanceof TargetEntityCastData targetingData) {
         ...
         wispEntity.m_6710_(targetEntity);
         wispEntity.m_146884_(Utils.getPositionFromEntityLookDirection(entity, 2.0F).m_82492_(0.0, 0.2, 0.0));
   ...
   private LivingEntity findTarget(LivingEntity caster) {
      return Utils.raycastForEntity(caster.m_9236_(), caster, 64.0F, true, 0.35F) instanceof EntityHitResult entityHit
