...
public class CloudOfRegenerationSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "cloud_of_regeneration");
   ...
   public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
      return List.of(
         ...
         Component.m_237110_("ui.irons_spellbooks.radius", new Object[]{Utils.stringTruncation(5.0, 1)})
      );
   }
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      level.m_45976_(LivingEntity.class, entity.m_20191_().m_82400_(5.0)).forEach(target -> {
         if (target.m_20238_(entity.m_20182_()) < 25.0 && Utils.shouldHealEntity(entity, target)) {
            ...
            PacketDistributor.sendToPlayersTrackingEntityAndSelf(entity, new HealParticlesPacket(target.m_20182_()));
         }
      });
      PacketDistributor.sendToPlayersTrackingEntityAndSelf(entity, new RegenCloudParticlesPacket(entity.m_20182_()));
