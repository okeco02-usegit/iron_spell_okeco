...
public class AngelWingsSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "angel_wing");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      entity.m_147207_(new MobEffectInstance((MobEffect)MobEffectRegistry.ANGEL_WINGS.get(), this.getEffectDuration(spellLevel, entity)), entity);
