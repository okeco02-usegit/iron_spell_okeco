...
public class FireflySwarmSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "firefly_swarm");
   ...
   public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      if (spawn == null) {
         ...
         if (raycast.m_6662_() == Type.ENTITY) {
            target = ((EntityHitResult)raycast).m_82443_();
      ...
      fireflies.m_20219_(spawn.m_82520_(0.0, 0.5, 0.0));
