...
public class EarthquakeSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "earthquake");
   ...
   public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
      return List.of(
         ...
         Component.m_237110_("ui.irons_spellbooks.slowness_effect", new Object[]{this.getSlownessAmplifier(spellLevel, caster) + 1}),
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      if (spawn == null) {
         spawn = Utils.raycastForEntity(world, entity, 32.0F, true, 0.15F).m_82450_();
   ...
   private int getSlownessAmplifier(int spellLevel, LivingEntity caster) {
      return Mth.m_14045_((int)this.getDamage(spellLevel, caster) - 2, 0, 2);
   }
}
