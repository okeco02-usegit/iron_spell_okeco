...
public abstract class AbstractEldritchSpell extends AbstractSpell {
   ...
   public CastResult canBeCastedBy(int spellLevel, CastSource castSource, MagicData playerMagicData, Player player) {
      return !this.isLearned(player)
         ? new CastResult(CastResult.Type.FAILURE, Component.m_237115_("ui.irons_spellbooks.cast_error_unlearned").m_130940_(ChatFormatting.RED))
         : super.canBeCastedBy(spellLevel, castSource, playerMagicData, player);
   }
