...
public class AcupunctureSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "acupuncture");
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      if (playerMagicData.getAdditionalCastData() instanceof TargetEntityCastData targetData) {
         ...
         if (targetEntity != null) {
            ...
            Vec3 center = targetEntity.m_20182_().m_82520_(0.0, targetEntity.m_20192_() / 2.0F, 0.0);
            float degreesPerNeedle = 360.0F / count;

            for (int i = 0; i < count; i++) {
               Vec3 offset = new Vec3(0.0, Math.random(), 0.55)
                  .m_82541_()
                  .m_82490_(targetEntity.m_20205_() + 2.75F)
                  .m_82524_(degreesPerNeedle * i * (float) (Math.PI / 180.0));
               ...
               needle.shoot(motion.m_82490_(0.35F));
   ...
   private int getCount(int spellLevel, LivingEntity caster) {
      return (int)((4 + spellLevel) * this.getSpellPower(spellLevel, caster));
   }
