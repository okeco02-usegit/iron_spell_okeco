...
public class DevourSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "devour");
   ...
   public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
      return List.of(
         ...
         Component.m_237110_("ui.irons_spellbooks.max_hp_on_kill", new Object[]{this.getHpBonus(spellLevel, caster)})
      );
   }
