...
public class BloodNeedlesSpell extends AbstractSpell {
   private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "blood_needles");
   ...
   public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
      return List.of(
         ...
         Component.m_237110_("ui.irons_spellbooks.projectile_count", new Object[]{this.getCount(spellLevel)})
      );
   }
   ...
   public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
      ...
      for (int i = 0; i < count; i++) {
         ...
         Vec3 spawn = entity.m_146892_()
            .m_82549_(
               new Vec3(0.0, 1.5, 0.0)
                  .m_82535_(rotation * (float) (Math.PI / 180.0))
                  .m_82496_(-entity.m_146909_() * (float) (Math.PI / 180.0))
                  .m_82524_(-entity.m_146908_() * (float) (Math.PI / 180.0))
            );
