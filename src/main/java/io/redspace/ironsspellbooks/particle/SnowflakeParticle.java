...
public class SnowflakeParticle extends TextureSheetParticle {
   ...
   public void m_5989_() {
      ...
      if (this.f_107224_++ < this.f_107225_ && !(this.f_107230_ <= 0.0F)) {
         this.f_107215_ = this.f_107215_ + this.f_107223_.m_188501_() / 5000.0F * (this.f_107223_.m_188499_() ? 1 : -1);
         this.f_107217_ = this.f_107217_ + this.f_107223_.m_188501_() / 5000.0F * (this.f_107223_.m_188499_() ? 1 : -1);
         this.f_107216_ = this.f_107216_ - this.f_107226_;
         this.f_107215_ = this.f_107215_ * this.f_172258_;
         this.f_107217_ = this.f_107217_ * this.f_172258_;
         this.f_107216_ = this.f_107216_ * this.f_172258_;
