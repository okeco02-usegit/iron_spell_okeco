...
public class EmberParticle extends TextureSheetParticle {
   ...
   public void m_5989_() {
      super.m_5989_();
      this.f_107215_ = this.f_107215_ + this.f_107223_.m_188501_() / 100.0F * (this.f_107223_.m_188499_() ? 1 : -1);
      this.f_107216_ = this.f_107216_ + this.f_107223_.m_188501_() / 100.0F;
      this.f_107217_ = this.f_107217_ + this.f_107223_.m_188501_() / 100.0F * (this.f_107223_.m_188499_() ? 1 : -1);
