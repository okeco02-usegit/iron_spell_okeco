...
public class SoundRegistry {
   private static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(Registries.f_256840_, "irons_spellbooks");
   ...
   private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
      return SOUND_EVENTS.register(name, () -> SoundEvent.m_262824_(ResourceLocation.fromNamespaceAndPath("irons_spellbooks", name)));
   }
}
