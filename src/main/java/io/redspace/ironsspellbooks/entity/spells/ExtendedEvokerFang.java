   ...
   public void m_8119_() {
      ...
      if (this.attackStarted && this.warmupDelayTicks == -8) {
         if (this.m_9236_().f_46443_) {
            for (int i = 0; i < 12; i++) {
               double d0 = this.m_20185_() + (this.f_19796_.m_188500_() * 2.0 - 1.0) * this.m_20205_() * 0.5;
               double d1 = this.m_20186_() + 0.05 + this.f_19796_.m_188500_();
               double d2 = this.m_20189_() + (this.f_19796_.m_188500_() * 2.0 - 1.0) * this.m_20205_() * 0.5;
               ...
               this.m_9236_().m_7106_(ParticleTypes.f_123797_, d0, d1 + 1.0, d2, d3, d4, d5);
            }
         } else {
            for (LivingEntity livingentity : this.m_9236_().m_45976_(LivingEntity.class, this.m_20191_().m_82377_(0.4, 0.0, 0.4))) {
