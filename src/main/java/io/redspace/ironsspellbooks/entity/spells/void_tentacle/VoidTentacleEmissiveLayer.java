...
public class VoidTentacleEmissiveLayer extends GeoRenderLayer<VoidTentacle> {
   ...
   public void render(
      ...
      poseStack.m_85836_();
      float f = Mth.m_14031_((float)((animatable.f_19797_ + partialTick + (animatable.m_20185_() + animatable.m_20189_()) * 500.0) * 0.15F)) * 0.5F + 0.5F;
      this.getRenderer()
         .actuallyRender(
            poseStack, animatable, bakedModel, renderType, bufferSource, vertexconsumer, true, partialTick, 15728880, OverlayTexture.f_118083_, f, f, f, 1.0F
         );
      poseStack.m_85849_();
   }
}
