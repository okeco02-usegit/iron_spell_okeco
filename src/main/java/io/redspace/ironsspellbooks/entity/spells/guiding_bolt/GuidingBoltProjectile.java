...
public class GuidingBoltProjectile extends AbstractMagicProjectile {
   ...
   public GuidingBoltProjectile(Level levelIn, LivingEntity shooter) {
      this((EntityType<? extends GuidingBoltProjectile>)EntityRegistry.GUIDING_BOLT.get(), levelIn, shooter);
   }
   ...
   protected void doImpactSound(Supplier<SoundEvent> sound) {
      this.f_19853_
         .m_6263_(null, this.m_20185_(), this.m_20186_(), this.m_20189_(), sound.get(), SoundSource.NEUTRAL, 2.0F, 0.9F + Utils.random.m_188501_() * 0.4F);
   }
   ...
   protected void m_5790_(EntityHitResult entityHitResult) {
      ...
      if (DamageSources.applyDamage(
            entityHitResult.m_82443_(), this.damage, ((AbstractSpell)SpellRegistry.GUIDING_BOLT_SPELL.get()).getDamageSource(this, this.m_19749_())
         )
         && entityHitResult.m_82443_() instanceof LivingEntity livingEntity) {
         livingEntity.m_7292_(new MobEffectInstance((MobEffect)MobEffectRegistry.GUIDING_BOLT.get(), 500));
      }
