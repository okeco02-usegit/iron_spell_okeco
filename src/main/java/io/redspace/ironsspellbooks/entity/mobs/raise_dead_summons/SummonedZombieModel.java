...
public class SummonedZombieModel extends GeoModel<SummonedZombie> {
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "textures/entity/summoned_zombie.png");
   public static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "geo/abstract_casting_mob.geo.json");
