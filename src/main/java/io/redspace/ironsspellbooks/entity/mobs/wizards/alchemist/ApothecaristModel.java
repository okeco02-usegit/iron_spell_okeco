...
public class ApothecaristModel extends AbstractSpellCastingMobModel {
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "textures/entity/apothecarist.png");
   public static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "geo/piglin_casting_mob.geo.json");
   ...
   public void setCustomAnimations(AbstractSpellCastingMob entity, long instanceId, AnimationState<AbstractSpellCastingMob> animationState) {
      ...
      if (entity.f_20913_ > 0) {
         float rot = Mth.m_14179_((entity.f_20913_ - partialTick) / 10.0F, 0.0F, (float) Math.PI);
         this.transformStack.pushRotation(rightArm, rot, 0.0F, 0.0F);
      }

      if (leftEar != null && rightEar != null) {
         Vector2f walkanimation = this.getLimbSwing(entity, entity.f_267362_, partialTick);
         float r = Mth.m_14089_(walkanimation.y * 0.6662F + (float) Math.PI) * 2.0F * walkanimation.x * 0.5F;
         r *= 0.3F;
         r += 0.25132743F;
