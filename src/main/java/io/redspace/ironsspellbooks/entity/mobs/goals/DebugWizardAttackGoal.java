   ...
   public void m_8037_() {
      if (this.tickCount++ % 200 == 0) {
         IronsSpellbooks.LOGGER
            .debug(
               "DebugWizardAttackGoal:  mob.initiateCastSpell:{}({}), pos:{}, isCasting:{}, isClient:{}",
               new Object[]{this.spell.getSpellId(), this.spellLevel, this.mob.m_20182_(), this.spellCastingMob.isCasting(), this.mob.f_19853_.m_5776_()}
            );
