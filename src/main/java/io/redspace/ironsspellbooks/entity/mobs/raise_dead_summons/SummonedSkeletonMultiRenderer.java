...
public class SummonedSkeletonMultiRenderer extends HumanoidRenderer<SummonedSkeleton> {
   ...
   public static final ResourceLocation TEXTURE_ALT = ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "textures/entity/summoned_skeleton_alt.png");

   public SummonedSkeletonMultiRenderer(Context pContext) {
      super(pContext, new SummonedSkeletonModel());
      this.vanillaRenderer = new SkeletonRenderer(pContext) {
         public ResourceLocation m_5478_(AbstractSkeleton pEntity) {
