...
public class DeadKingEmissiveLayer extends GeoRenderLayer<AbstractSpellCastingMob> {
   public static final ResourceLocation TEXTURE_NORMAL = ResourceLocation.fromNamespaceAndPath(
      "irons_spellbooks", "textures/entity/dead_king/dead_king_glowing.png"
   );
   public static final ResourceLocation TEXTURE_ENRAGED = ResourceLocation.fromNamespaceAndPath(
      "irons_spellbooks", "textures/entity/dead_king/dead_king_enraged_glowing.png"
   );
